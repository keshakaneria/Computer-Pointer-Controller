...
class MouseController:
    def __init__(self, precision, speed):
        precision_dictionary={'high':100, 'low':1000, 'medium':500}
        speed_dictionary={'fast':1, 'slow':10, 'medium':5}

        self.precision=precision_dictionary[precision]
        self.speed=speed_dictionary[speed]
